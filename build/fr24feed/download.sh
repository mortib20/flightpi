...
if [ "$ARCH" == "x86_64" ]; then
    wget -c https://repo-feed.flightradar24.com/linux_x86_64_binaries/fr24feed_1.0.37-0_amd64.tgz -O - | tar -xz
    mv fr24feed_amd64 fr24feed
fi

if [ "$ARCH" == "x86" ]; then
    wget -c https://repo-feed.flightradar24.com/linux_x86_binaries/fr24feed_1.0.37-0_i386.tgz -O - | tar -xz
